...
const FavIcon = ({ displayAlert, selected, fill }) => {
  ...
  //   setFavorite(favorite===[...favorite, this.data])
  ...
  return (
    <svg width="20" height="17" viewBox="0 0 24 19" fill={fill} xmlns="http://www.w3.org/2000/svg">
      ...
      {
        !!displayAlert &&
        <circle cx="21" cy="4" r="4" fill="#FFFF00" stroke="#C80000" strokeWidth="0.5" />
      }
    </svg>
  );
};
